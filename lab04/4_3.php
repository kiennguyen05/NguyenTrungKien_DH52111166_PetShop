...
<?php 
    $b4=$b; krsort($b4);
    echo "mang b sau khi sap xep theo key giảm dần ";

showArray($b4);
?>
<?php 
    $b3=$b; arsort($b3);
    echo "mang b sau khi sap xep theo chiều giảm dần ";

showArray($b3);
?>
<?php 
$a2=$b; rsort($a2);
echo "mang b sau khi sap xep theo chiều giảm dần và thay đổi key";
showArray($a2);
?>
